...
WiFiUDP Udp;
const IPAddress outIp(172,20,10,4);        // remote IP (not needed for receive)
...
void loop() {
    sendOSC(touchRead(T2), "/area3/touch1/");
    sendOSC(touchRead(T3), "/area3/touch2/");
    sendOSC(touchRead(T4), "/area3/touch3/");
    sendOSC(touchRead(T5), "/area3/touch4/");
