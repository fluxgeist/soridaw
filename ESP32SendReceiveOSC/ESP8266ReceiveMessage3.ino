...
WiFiUDP Udp;
const IPAddress outIp(172,20,10,5);        // remote IP (not needed for receive)
...
void loop() {
    sendOSC(touchRead(T2), "/area4/touch1/");
    sendOSC(touchRead(T3), "/area4/touch2/");
    sendOSC(touchRead(T4), "/area4/touch3/");
    sendOSC(touchRead(T5), "/area4/touch4/");
